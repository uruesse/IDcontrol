...
DELETE FROM BEITRAG WHERE MGLNR > 1122333700000;
DELETE FROM OFFENERECHNUNGEN WHERE MGLNR > 1122333700000;
...
INSERT INTO BEITRAG (MGLNR,FNR,BEITRAGSPOSITION,BEITRAGSKOMMENTAR,FAELLIG_START,FAELLIG_ENDE,ABRECHNUNGSSTATUS,ZAHLUNGSWEISE) VALUES 
...
INSERT INTO OFFENERECHNUNGEN (RECHNUNGSNUMMER, MGLNR,RECHNUNGSDATUM,ZAHLUNGSZIEL,ZAHLMODUS,MAHNSTUFE,RECHNUNGSSUMME) VALUES 
(9000000001,1122333700003,'2019-02-21','2019-03-08','Lastschrift',0,5500),
(9000000002,1122333700003,'2019-02-21','2019-03-08','Lastschrift',0,2250);
